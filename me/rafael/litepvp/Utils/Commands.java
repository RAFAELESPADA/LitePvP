    ...
    if (label.equalsIgnoreCase("coins")) {
      if ((sender instanceof Player))
      {
        if (args.length == 0)
        {
          ...
          p.playSound(p.getLocation(), Sound.valueOf(this.main.getConfig().getString("Sound.SucefullMessage")), 1.0F, 1.0F);
        ...
        if (args[0].equalsIgnoreCase("set"))
        {
          if (!p.hasPermission("kitpvp.coins.set"))
          {
            ...
            p.playSound(p.getLocation(), Sound.valueOf(this.main.getConfig().getString("Sound.NoPermissionMessage")), 1.0F, 1.0F);
            return true;
          }
          if (args.length == 2)
          {
            ...
            if (t == null)
            {
              ...
              p.playSound(p.getLocation(), Sound.valueOf(this.main.getConfig().getString("Sound.ErrorMessage")), 1.0F, 1.0F);
              return true;
            }
          }
          if (args.length == 3)
          {
            ...
            t.playSound(p.getLocation(), Sound.valueOf(this.main.getConfig().getString("Sound.SucefullMessage")), 1.0F, 1.0F);
        ...
        if (args[0].equalsIgnoreCase("remove"))
        {
          ...
          if (args.length == 2)
          {
            ...
            {
              p.sendMessage("§cThis player is offline");
              p.playSound(p.getLocation(), Sound.ARROW_HIT, 10.0F, 30.0F);
              return true;
            }
          }
          if (args.length == 3)
        ...
        if (args[0].equalsIgnoreCase("pay"))
        {
          ...
          if (args.length == 3)
          {
            ...
            if (Coins.getCoins(p.getName()).doubleValue() != 0.0D)
            {
              ...
              Coins.addCoins(t.getName(), amount);
              p.playSound(p.getLocation(), Sound.ORB_PICKUP, 10.0F, 30.0F);
              p.sendMessage(ChatColor.GOLD + "You pay " + amount + "Coins to the player" + t.getName());
              t.playSound(t.getLocation(), Sound.ORB_PICKUP, 10.0F, 30.0F);

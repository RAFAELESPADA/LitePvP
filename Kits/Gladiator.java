  ...
  implements Listener, CommandExecutor
{
  public boolean onCommand(CommandSender sender, Command command, String cmd, String[] args)
  {
    ...
    especial1.setDisplayName("§6Gladiator");
    ...
    if (cmd.equalsIgnoreCase("gladiator"))
    {
      ...
      p.sendMessage("§7Voce escolheu o kit §cGladiator §7!");
      p.setGameMode(GameMode.ADVENTURE);
      p.getInventory().clear();
      Array.kit.put(p, "Gladiator");
      ...
      TitleAPI.sendTitle(p, Integer.valueOf(5), Integer.valueOf(20), Integer.valueOf(5), "§a§lVoce escolheu", "§f§lO kit Gladiator");
      for (int i = 0; i <= 34; i++) {

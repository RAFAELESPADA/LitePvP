  ...
  implements Listener, CommandExecutor
{
  public boolean onCommand(CommandSender sender, Command command, String cmd, String[] args)
  {
    ...
    if (cmd.equalsIgnoreCase("infernor"))
    {
      ...
      p.sendMessage("§7Voce escolheu o kit §cInfernor §7!");
      ...
      TitleAPI.sendTitle(p, Integer.valueOf(5), Integer.valueOf(20), Integer.valueOf(5), "§a§lVoce escolheu", "§f§lO kit Infernor");
      for (int i = 0; i <= 34; i++) {
